...
| T4 | post-compact | SDK PostCompact hook | the compacted agent |
...
Empty segments are dropped. Byte-identical output is required when all gate predicates
return True (no suppression active): this verifies the refactor changes no behavior.
